...
//					"The image must be of type TYPE_BYTE_GRAY");
	...
	final private int[] fillArray(int length, int value) {
       ...
       public static void main(String[] args) {
        try {
            String filename="cell_stain.v2binary.jpg";
        ...
        System.out.println("fie "+file.getAbsolutePath());
                  ...
                  int shapeSize=1;
                    ...
                    BufferedImage image1=d.execute(image);
                     String path="images/malaria.jpg/"+"cell_stain.v2dilate.jpg";
                    ImageIO.write(image1, "jpg", new File(path));
        } catch (IOException ex) {
            Logger.getLogger(Dilation.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
