...
public class CreatingTestDataofImage {
...
//String[] piexels=args[0].split("x");
	...
	args=new String[3];
	args[1]="F:\\maven\\SvmForImageClassification\\faces96\\9540741";//image folderpath
...
try(PrintWriter out = new PrintWriter(new BufferedWriter(new FileWriter(HashMapfileSizecalc.pathfortestingdataCSV+"-input-"+args[2]+".csv", true)))) {
...
public static void creatingTestingDatasetForImage(String trainingdatasetpath,String classfiedinto ) throws IOException
{
