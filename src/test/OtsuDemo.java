...
//		}
		...
		try
		{
			...
			javax.imageio.ImageIO.write(dstFrame.getBufferImage(), "jpg", new File(basename+"_binary.jpg"));
...
//			System.exit(1);
//		}
 String filename="malaria.jpg";
              File file =new File("C:\\Documents and Settings\\admin\\My Documents\\rahul\\Java file\\Traffic Congestion Control\\images\\13 cars.jpg");
                            System.out.println("fie "+file.getAbsolutePath());
		new OtsuDemo("C:\\Documents and Settings\\admin\\My Documents\\rahul\\Java file\\Traffic Congestion Control\\images\\13 cars.jpg");
	}
}
