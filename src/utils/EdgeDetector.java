...
public class EdgeDetector extends Applet {
	...
	private void writeEdges(int pixels[]) {
        ...
        public ArrayList<Complex> getEdgePixels(BufferedImage img)
        {
      ...
      public static void main(String args[])throws Exception
        {
            ...
            BufferedImage img=ImageIO.read(new File("D:\\PROJECT\\VizShopping\\web\\product_images\\softtoys\\1.jpg"));
